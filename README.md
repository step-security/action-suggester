...
[![Test](https://github.com/step-security/action-suggester/workflows/Test/badge.svg)](https://github.com/step-security/action-suggester/actions?query=workflow%3ATest)
[![reviewdog](https://github.com/step-security/action-suggester/workflows/reviewdog/badge.svg)](https://github.com/step-security/action-suggester/actions?query=workflow%3Areviewdog)
...
jobs:
  go:
    ...
    steps:
      ...
      - run: gofmt -w -s .
      - uses: step-security/action-suggester@v1
        with:
          tool_name: gofmt
  shell:
